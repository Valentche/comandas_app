...
export const produtoService = {
  ...
  list: async (params = {}) => {
    ...
    if (valor_min !== undefined && valor_min !== null)
      queryParams.append("valor_min", valor_min);
    if (valor_max !== undefined && valor_max !== null)
      queryParams.append("valor_max", valor_max);
  ...
  listPublic: async (params = {}) => {
    ...
    const response = await api.get(
      `${PRODUTO.PUBLIC}?${queryParams.toString()}`,
    );
    return response.data;
  },
};
